...
public class TimeHelper {
	...
	public static double generateIdealPercent(Goal goal,viewModel model)
	{
		return generateIdealPercent(goal.getStartTime(),goal.getEndTime(),model);
	}
	
	public static double generateIdealPercent(Stage stage,viewModel model)
	{
		return generateIdealPercent(stage.getStartTime(),stage.getEndTime(),model);
	}
